...
const mapOutboundRefs = (ref: any) => ref.parent.uid // roamBlock
  ? {
      mdx: ref.body,
...
const mapInboundRefs = (ref: any) => ref.parent.fields.parentPage // roamBlock
  ? {
      content: (
        <ul>
...
export const dataToNote = (data: any) => data.roamPage
  ? {
...
export const dataToSlug = (data: any) => data.roamPage
